...
- Die Bossbar oben zeigt das aktuelle Ziel und den Fortschritt, z. B. **„Item 43/1369: Diamant“**. Beim Betreten der Welt steht das aktuelle Ziel außerdem im Chat.
...
- **Überspringen:** Übersprungene Items zählen nicht als gesammelt. Aus `Item 43/1369` wird beim Überspringen `Item 43/1368`.
